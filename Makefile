# Simple Makefile for Experience Viewer (Win32)
# Usage:
#   make
#   make CXX=clang++
#   make clean
...
# Uncomment next line to link statically (bigger exe, but portable)
# LDFLAGS  += -mwindows  -static -static-libgcc -static-libstdc++

LIBS := -lcomdlg32 -lcomctl32 -luser32 -lgdi32 -lshell32 -ladvapi32 -lole32
